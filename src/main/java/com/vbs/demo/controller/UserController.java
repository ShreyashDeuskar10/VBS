...
public class UserController {
    ...
    public String register(@RequestBody User user) {
        ...
        // Account number auto-generated by @PrePersist in User.java
        User savedUser = userRepo.save(user);
        return "Signup Successful! Your account number is: " + savedUser.getAccountNumber();
    }
    ...
    public DisplayDto display(@PathVariable int id) {
        ...
        displayDto.setBankName(user.getBankName());
        displayDto.setAccountNumber(user.getAccountNumber());
        displayDto.setIfscCode(user.getIfscCode());
        displayDto.setBranch(user.getBranch());
        return displayDto;
    }

    @PostMapping("/update-bank-details/{id}")
    public String updateBankDetails(@PathVariable int id, @RequestBody DisplayDto bankDetails) {
        User user = userRepo.findById(id)
                .orElseThrow(() -> new RuntimeException("User not found"));
        user.setBankName(bankDetails.getBankName());
        // DO NOT update account number - it's unique and auto-generated
        user.setIfscCode(bankDetails.getIfscCode());
        user.setBranch(bankDetails.getBranch());
        userRepo.save(user);
    ...
    public String add(@RequestBody User user, @PathVariable int adminId) {
        ...
        // Account number auto-generated by @PrePersist
        User savedUser = userRepo.save(user);
        ...
        return "Added Successfully. Account number: " + savedUser.getAccountNumber();
    }
